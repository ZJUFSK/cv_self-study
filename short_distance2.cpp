...
void action()
{
  ...
  // Local iconic variables
  HObject  ho_Image0, ho_ImageScaled, ho_Regions;
  HObject  ho_RegionOpening, ho_ConnectedRegions, ho_SelectedRegions;
  HObject  ho_ObjectSelected1, ho_ObjectSelected2;

  // Local control variables
  HTuple  hv_WindowHandle, hv_MinDistance, hv_Row1;
  HTuple  hv_Column1, hv_Row2, hv_Column2;

  ReadImage(&ho_Image0, "E:/1.19/note/1.24/1.bmp");
  if (HDevWindowStack::IsOpen())
    DispObj(ho_Image0, HDevWindowStack::GetActive());
    system("pause");
  ...
  //scale_image (Image0, ImageScaled, 10.625, 0)
  ScaleImage(ho_Image0, &ho_ImageScaled, 5, 0);
  if (HDevWindowStack::IsOpen())
    DispObj(ho_ImageScaled, HDevWindowStack::GetActive());
    system("pause");
  // stop(...); only in hdevelop
  Threshold(ho_ImageScaled, &ho_Regions, 161, 255);
  OpeningRectangle1(ho_Regions, &ho_RegionOpening, 15, 15);

  Connection(ho_Regions, &ho_ConnectedRegions);
  SelectShape(ho_ConnectedRegions, &ho_SelectedRegions, "area", "and", 186190, 500000);
  if (HDevWindowStack::IsOpen())
  ...
  SelectObj(ho_SelectedRegions, &ho_ObjectSelected2, 2);

  DistanceRrMin(ho_ObjectSelected1, ho_ObjectSelected2, &hv_MinDistance, &hv_Row1, 
  ...
  if (HDevWindowStack::IsOpen())
    DispObj(ho_Image0, HDevWindowStack::GetActive());
  DispCross(hv_WindowHandle, hv_Row1, hv_Column1, 20, 0);
  DispCross(hv_WindowHandle, hv_Row2, hv_Column2, 20, 0);
  DispLine(hv_WindowHandle, hv_Row1, hv_Column1, hv_Row2, hv_Column2);
  disp_message(hv_WindowHandle, //'两个区域最小距离='
      "\301\275\270\366\307\370\323\362\327\356\320\241\276\340\300\353="+hv_MinDistance, 
      "window", 200, 300, "blue", "false");
  system("pause");
  // stop(...); only in hdevelop
}
